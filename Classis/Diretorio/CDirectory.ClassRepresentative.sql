...
and  (SELECT TOP 1 UMAT2.CODTUR FROM UMATALUN UMAT2 WHERE UMAT2.MATALUNO = EALUNOS.MATRICULA AND UMAT2.PERLETIVO = UMatricPL.PerLetivo GROUP BY UMAT2.CODTUR ORDER BY COUNT(UMAT2.CODTUR) DESC) ='Toddler B'
...
Order by Nome, grade_level, Nome_Familia
/*
Select distinct 
	Zfamilia.Nome,
	Zfamilia.Pessoa1, 
