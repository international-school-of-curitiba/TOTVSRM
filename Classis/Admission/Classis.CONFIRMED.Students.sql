...
and (A_DATAENTRADAISC between (case when 1 =2 then (Select AugustBegin from Z_SchoolCalendar where Z_SchoolCalendar.CodPerlet = UMATRICPL.PERLETIVO) else  (Select JanuaryBegin from Z_SchoolCalendar where Z_SchoolCalendar.CodPerlet = UMATRICPL.PERLETIVO) end) and (case when 1 =2 then (Select DecemberEnd from Z_SchoolCalendar where Z_SchoolCalendar.CodPerlet = UMATRICPL.PERLETIVO) else  (Select JulyEnd from Z_SchoolCalendar where Z_SchoolCalendar.CodPerlet = UMATRICPL.PERLETIVO) end)
or A_RETURNEDTOISC between (case when 1 =2 then (Select AugustBegin from Z_SchoolCalendar where Z_SchoolCalendar.CodPerlet = UMATRICPL.PERLETIVO) else  (Select JanuaryBegin from Z_SchoolCalendar where Z_SchoolCalendar.CodPerlet = UMATRICPL.PERLETIVO) end) and (case when 1 =2 then (Select DecemberEnd from Z_SchoolCalendar where Z_SchoolCalendar.CodPerlet = UMATRICPL.PERLETIVO) else  (Select JulyEnd from Z_SchoolCalendar where Z_SchoolCalendar.CodPerlet = UMATRICPL.PERLETIVO) end))
Order By Quebra$$, DataEntrada, A_NomeReduzido